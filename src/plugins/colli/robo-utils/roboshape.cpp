...
bool RoboShape::IsRobotReadingforRad( float anglerad, float length )
{
...
// returns if the reading is 'in' the robot
bool RoboShape::IsRobotReadingforDegree( float angledeg, float length )
{
...
float RoboShape::GetRobotLengthforRad( float anglerad )
{
...
// return the length of the robot for a specific angle
float RoboShape::GetRobotLengthforDegree( float angledeg )
{
...
float RoboShape::GetCompleteWidthX()
{
...
float RoboShape::GetCompleteWidthY()
{
  if ( IsAngularRobot() == true )
...
float RoboShape::GetLaserOffsetX()
{
...
float RoboShape::GetLaserOffsetY()
{
