...
#ifndef _COLLI_FAST_BIWARD_DRIVE_MODE_CPP_
 ...
 */
CFastBiwardDriveModule::CFastBiwardDriveModule( Logger* logger, Configuration *config, CFastForwardDriveModule*  forward_module,
 ...
 */
void CFastBiwardDriveModule::Update()
{
